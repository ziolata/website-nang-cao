...
cartbtn.forEach(function(button,index){
  button.addEventListener("click",function(event){
    ...
    var Price = product.querySelector("money").innerText
...
function addItemToCart(Title, Price, Img) {
  ...
  var cartRowContents = `
  <div class="cart-item cart-column"><img class="cart-item-image" src="${Img}" width="100" height="100"><span class="cart-item-title">${Title}</span></div><span class="cart-price cart-column">'${Price}'</span><div class="cart-quantity cart-column"><input class="cart-quantity-input" type="number" value="1"><button class="btn btn-danger" type="button">Xóa</button></div>`
